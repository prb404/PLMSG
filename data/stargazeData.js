...
Game.stargazeData = (function(){
	...
	instance.intro = {
		...
		para5: '"You will start over, a new life, but in exchange for your soul, I will reward your next self with the knowledge you have gained during your time in this universe and some of the most valuble material in this side of the multiverse: Perfectionicism."',
		category: "general",
		unlocked: true
	};

	instance.darkMatter = {
		name: "Perfectionicism",
		desc: "Here, you can see how much Perfectionicism you have acquired and the earnings you will recieve upon reset (in brackets). You can find out how Perfectionicism is gained and can spend it on Perfectionicism-specific upgrades.",
		current: 0,
		count: 0,
		category: "general",
		unlocked: true
...
Game.darkMatter = (function(){
	...
	************/
	...
	instance.wonder = {
		name: "Wonders",
		desc: "You get Perfectionicism for the floors of the Wonder Station that you complete. It is likely you will have achieved all of these in your first run before resetting. You get 4 Perfectionicism for every floor completed, but 2 for the last floor (only one wonder).",
	};

	instance.sphere = {
		name: "Sphere",
		desc: "For building a sphere in your home system and thus completing it, you get 15 Perfectionicism. For every sphere built in another system, you gain 5 Perfectionicism."
	};

	instance.research = {
		name: "Research Efficiency",
		desc: "For every 25 Research Efficiencies in any of the repurchaseable researches, you will get 2 Perfectionicism.",
	};

	instance.rank = {
		name: "Achievement Rank",
		desc: "For every achievement rank attained, you will get 2 Perfectionicism. Due to the easy difficulty in the first few achievement ranks, this will be your primary source of Perfectionicism early in a run.",
	};

	instance.swarm = {
		name: "Swarms",
		desc: "One of the more complex systems, your Perfectionicism gained from swarms is judged on an old mathematical sequence: Pascal's Triangle. You will get 1 dark matter for passing each triangular number of swarms necessary. For example: 1,3,6,10,15,21...",
	};
...
Game.prestigeData = (function(){
	...
	************/
	...
	instance.respec = {
		name: "Respec",
		desc: "When you have made a mistake or want to change your upgrades, you can respec and refund every upgrade for Perfectionicism. Unfortunately, this huge amount of power can only be unleashed a finite number of times. The Overlord graciously gives you 3 free chances at redemption, but the rest will have to be earned through rebirth (1 extra every 3 times). <br><b>NB: You will lose machines gained with these ugprades, including all T5 machines. You will also divide your storage by 128 if you have the starting storage. (6400/50 = 128).</b>",
		cost: 0,
		category: "intro",
	};

	instance.increaseProd1 = {
		name: "Perfectionicism Boost",
		desc: "This adds a 1% boost to all resources (including science) for each Perfectionicism you have not spent.",
		cost: 30,
		category: "darkMatter",
		onApply: function(){
	        dmBoost += 0.01;

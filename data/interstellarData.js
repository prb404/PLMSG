...
Game.interstellarData = (function(){
	...
	instance.antimatter = {
		name: 'Curiosity',
		desc: 'Your fuel for interstellar travel is produced here. Unfortunately, you can only handle 100k Curiosity per Star System as it is incredibly volatile.<br><br><button class="btn btn-default" onclick="toggleAntimatter()">Toggle Curiosity <span id="antimatterToggled">On</span></button>',
		category: 'general',
		unlocked: false
	};
...
Game.commsData = (function(){
	...
	instance.IRS = {
		entryName: 'IRS',
		name: 'Transdisciplinarity Radar Scanner',
